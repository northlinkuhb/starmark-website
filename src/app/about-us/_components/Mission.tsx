...
const Mission = () => {
  ...
  return (
    ...
    >
      {/* Blue Card */}
      <div className="bg-[#004EB2] relative h-fit ~pb-[8.5625rem]/[19.375rem] ~pt-[0.875rem]/[1.875rem] text-white ~px-[0.5625rem]/[1.25rem] ~gap-[0.625rem]/[1.875rem] flex md:flex-row flex-col ~rounded-[0.625rem]/[1.873125rem]">
        ...
        <p className="~text-[0.875rem]/[1.873125rem] leading-[110%]">
          Deliver end-to-end logistics excellence tailored to business needs,
          driven by technology, sustainability, and a customer-first approach.
        </p>
      </div>
      ...
      <div
        ref={whiteCardRef}
        className="bg-white relative ~pb-[8.5625rem]/[19.375rem] ~pt-[0.875rem]/[1.875rem] text-black ~px-[0.5625rem]/[1.25rem] ~gap-[0.625rem]/[1.875rem] flex md:flex-row flex-col ~rounded-[0.625rem]/[1.873125rem]"
      >
        ...
        <p className="~text-[0.875rem]/[1.873125rem] leading-[110%]">
          To be the most trusted global logistics partner, redefining container
          and supply chain solutions with innovation and sustainability.
        </p>
      </div>
    </div>
  );
